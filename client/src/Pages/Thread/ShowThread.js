    ...
    return (
        <div style={{padding: "2rem"}}>
            ...
            <Button variant="contained"
                    ...
                    onClick={getPosts}>Carregar mais respostas</Button>

            <Button variant="contained" color="primary" onClick={() => setIsReplying(true)}>Responder</Button>
            {isReplying && (
                <form onSubmit={handleReply}>
                    ...
                    <TextField width
                                ...
                                margin="normal"
                                required
                               label="Insira seu R.A"
                               value={replyRA}
                               onChange={e => setRA(e.target.value)}/><br />
                    ...
                    <br />
                   <Button variant="contained" color="primary" type="submit">Responder</Button>
                </form>
            )}
